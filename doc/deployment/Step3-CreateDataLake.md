...
|-----------------|-----------|-------------|
|EgressAppDomainName|Use value from Prerequisites Step 5 - Egress add-on application domain name to be used as allowed origin for CORS configuration attached to TRETargetBucket|*No default - must be specified*|
