...
1. listRequests - Lists all egress requests (Query)
2. updateRequest - Updates a given request with approval status, justification, and approver name (Mutation)
3. downloadData - Generates a S3 presigned URL which will be used by the frontend to download data associated with the request (Mutation)
